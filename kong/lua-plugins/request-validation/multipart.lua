local FileReader = require("kong.plugins.request-validation.file-reader")
local base64 = require("kong.plugins.request-validation.base64")
local qp = require("kong.plugins.request-validation.quoted-printable")
local MultiPart = {}
local CRLF = "\r\n"
